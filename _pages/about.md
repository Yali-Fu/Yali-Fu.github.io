...
<div style="display: flex; align-items: center; gap: 15px;margin-bottom: 20px;">
  ...
  <div>
    <b style="color: #0D1A26;">ScreenAgent: A Vision Language Model-driven Computer Control Agent</b><br>
...
<div style="display: flex; align-items: center; gap: 15px; margin-bottom: 20px;">
  ...
  <div>
    <b style="color: #0D1A26;">HC-GLAD: Dual Hyperbolic Contrastive Learning for Unsupervised Graph-Level Anomaly Detection</b><br>
...
<div style="display: flex; align-items: center; gap: 15px; margin-bottom: 20px;">
  ...
  <div>
    ...
    <b style="color: #0D1A26;">Yali Fu</b>, Jindong Li, Qi Wang, Qianli Xing.<br>
...
<div style="display: flex; align-items: center; gap: 15px; margin-bottom: 20px;">
  ...
  <div>
    <b style="color: #0D1A26;">LCD-Net: A Lightweight Remote Sensing Change Detection Network Combining Feature Fusion and Gating Mechanism</b><br>
...
<div style="display: flex; align-items: center; gap: 15px; margin-bottom: 20px;">
  ...
  <div>
    <b style="color: #0D1A26;">A Comprehensive Survey on CLIP Powered Domain Generalization and Adaptation: Review and Beyond</b><br>
